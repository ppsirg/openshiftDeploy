...
ALLOWED_HOSTS = [u'localhost',
                 u'yourproject-openshiftdomain.rhcloud.com',
                 u'.prod.rhcloud.com',]

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'blockchainpassport.wsgi.application'

#-----------------------------------------------------------------------
# APPS AND TZTIME CONFIGS
#-----------------------------------------------------------------------


#-----------------------------------------------------------------------
## STATIC, MEDIA AND OPENSHIFT CONFIGS
#-----------------------------------------------------------------------
